        ...
        <div class="instructions-content">
            <div class="instruction-section">
                ...
                <ul class="instruction-list">
                    <li>This exam contains <strong>${examConfig.pattern.totalQuestions}
...
function addModalStyles() {
    ...
    const styles = document.createElement('style');
    styles.id = 'modalStyles';
    styles.textContent = ` questions</strong> for a total of <strong>${examConfig.pattern.totalMarks} marks</strong></li>
...
function renderQuestionPalette() {
    ...
    const sectionPalettes = Object.values(sectionStats).map(section => {
        ...
        return `
            <div class="section-palette" data-section="${section.name}">
